...
class GeminiDeepResearchTool(BaseTool):
    ...
    Deep Research performs autonomous, multi-step web research and returns
    a detailed Markdown report with inline citations. Each call takes
    3-20 minutes.
    ...
    def _run(self, query: str) -> str:
        ...
        while time.time() - start_time < self.max_polling_time:
            ...
            if interaction.status == "completed":
                ...
                # (Updated for May 2026 Breaking Change: outputs[] replaced by steps[])
                try:
